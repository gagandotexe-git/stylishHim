  ...
  return (
    <div className="min-h-screen text-gray-800 flex flex-col items-center justify-center px-6 py-16 bg-[#F9F8F7]">
      ...
      <div className="text-center max-w-3xl">
        <h1 style={{color: THEME_COLOR}} className="text-4xl md:text-5xl font-serif mb-6 animate-fadeIn">
          Our Commitment to Sustainability
        </h1>
        <p className="text-gray-600 text-lg leading-relaxed">
          At <span style={{color: THEME_COLOR}} className="font-semibold">StylishHim</span>, we believe that beauty should not come at the cost of our planet.
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10 w-full max-w-6xl">
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 text-center hover:shadow-xl transition duration-300">
          <div className="flex justify-center mb-5">
            <Leaf size={64} strokeWidth={1.5} style={{color: THEME_COLOR}} />
          </div>
          <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3">Eco-friendly Sourcing</h2>
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 text-center hover:shadow-xl transition duration-300">
          <div className="flex justify-center mb-5">
            <Recycle size={64} strokeWidth={1.5} style={{color: THEME_COLOR}} />
          </div>
          <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3">Recyclable Packaging</h2>
          <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 text-center hover:shadow-xl transition duration-300">
          <div className="flex justify-center mb-5">
            <Sun size={64} strokeWidth={1.5} style={{color: THEME_COLOR}} />
          </div>
          <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3">Energy Efficiency</h2>
          <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <div className="mt-20 max-w-3xl text-center">
        <h3 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-4">Sustainability is Our Lifestyle</h3>
