  ...
  return (
    <div className="min-h-screen pb-12 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white p-10 rounded-2xl  ">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Use of Website</h2>
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Order Policy</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Intellectual Property</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Changes to Terms</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Governing Law</h2>
        <p className="text-gray-700 mb-3">
