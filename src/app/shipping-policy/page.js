  ...
  return (
    <div className="min-h-screen pb-12 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white p-10 rounded-2xl ">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Processing Time</h2>
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Delivery Time</h2>
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Shipping Charges</h2>
        <p className="text-gray-700 mb-3">
