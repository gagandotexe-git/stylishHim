  ...
  return (
    <div className="min-h-screen pb-12 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white p-10 rounded-2xl ">
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Processing Time</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Delivery Time</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Shipping Charges</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Order Tracking</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Lost or Damaged Shipments</h2>
        <p className="text-gray-700 mb-3">
