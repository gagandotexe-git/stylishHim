  ...
  return (
    <div className="min-h-screen pb-12 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white p-10 rounded-2xl  ">
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Information We Collect</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Use of Information</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Data Sharing</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Cookies & Tracking</h2>
        <p className="text-gray-700 mb-3">
          We use cookies and similar technologies to enhance user experience, analyze trends, and provide personalized content.
        </p>

        <h2 className="text-2xl font-semibold text-[#AD9682] mb-3 mt-6">Your Rights</h2>
        <p className="text-gray-700 mb-3">
