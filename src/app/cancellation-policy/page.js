  ...
  return (
    <div className="min-h-screen pb-12 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white p-10 rounded-2xl  ">
        <h1 style={{color: THEME_COLOR}} className="text-4xl font-bold mb-8 text-center">
          Cancellation Policy
        </h1>
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Eligibility for Cancellation</h2>
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">How to Cancel</h2>
        <p className="text-gray-700 mb-3">
          Send an email to <a href="mailto:stylishhim@gmail.com" style={{color: THEME_COLOR}} className="underline">stylishhim@gmail.com</a> with your order number and request for cancellation.
        </p>

        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Refund Process</h2>
        <p className="text-gray-700 mb-3">
        ...
        <h2 style={{color: THEME_COLOR}} className="text-2xl font-semibold mb-3 mt-6">Exceptions</h2>
        <p className="text-gray-700 mb-3">
